    ...
    <nav id="mainNav" class="navbar static-top navbar-toggleable-md navbar-inverse bg-inverse">
        ...
        <div class="collapse navbar-collapse" id="navbarExample">
            <ul class="sidebar-nav navbar-nav">
                <li class="nav-item <?php if($_SERVER['REQUEST_URI']=='/codeigniter/admin/') echo 'active'?>">
                    <a class="nav-link" href="<?=base_url()?>"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                </li>
				<li class="nav-item <?php if(strpos($_SERVER['REQUEST_URI'],'makes')!== false
						|| strpos($_SERVER['REQUEST_URI'],'models')!== false) echo 'active'?>">
					<a class="nav-link" href="<?=base_url()?>makes"><i class="fa fa-fw fa-car"></i> Makes & Models</a>
				</li>
				<li class="nav-item <?php if(strpos($_SERVER['REQUEST_URI'],'vehicles')!== false) echo 'active' ?>">
					<a class="nav-link" href="<?=base_url()?>vehicles"><i class="fa fa-fw fa-car"></i> Vehicles</a>
				</li>
				<li class="nav-item">
